...
\begin{document}
	...
	\begin{titlepage}
		...
		\HRule \\[0.8cm]
		{ \huge \bfseries Risolutore di Puzzle - Parte 2}\\[0.4cm] % Title of your document
		\HRule \\[1.5cm]
	...
	\input{sections/differenze_con_la_versione_precedente.tex}
	\input{sections/scelta_dell_algoritmo.tex}
\end{document}
